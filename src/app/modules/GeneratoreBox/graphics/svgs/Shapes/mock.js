...
const ARROW_ICONS = ['/assets/svgs/icons/arrow_up.svg', '/assets/svgs/icons/arrow_down.svg']
const PLUS_MINUS_ICONS = ['/assets/svgs/icons/minus.svg', '/assets/svgs/icons/plus.svg']
...
const COLOR_PALLETES_FRAMES = [
  {
    id: 1,
    palette: [{color: '#ffffff'}, {color: '#ff5161'}],
    isSelected: false,
  },
  {
    id: 2,
...
const QR_FRAMES = [
  ...
  {
    image: '/assets/svgs/Frame/frame_5.png',
    selected: false,
    type: 'roundedFrame',
  },
]
const QR_SHAPES = [
  ...
  },
  {
    ...
    childrens: [
      ...
      {
        image: '/assets/svgs/Shapes/EFT_8.png',
        selected: false,
        mode: 'eye-frame-plain-square',
        value: [0, 30, 30, 0],
      },
      {
        image: '/assets/svgs/Shapes/EFT_9.png',
        selected: false,
        mode: 'eye-frame-plain-square',
        value: [20, 90, 30, 0],
      },
  ...
  },
  {
    ...
    childrens: [
      ...
      {
        image: '/assets/svgs/Shapes/EBT_8.png',
        selected: false,
        mode: 'eye-ball-square-right',
        value: [0, 30, 30, 0],
      },
      {
        image: '/assets/svgs/Shapes/EBT_9.png',
        selected: false,
